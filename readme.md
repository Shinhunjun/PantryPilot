...
### 🥈 Second Place Overall - Google Cloud MLOps Expo
...
## 🧩 Project Overview
Here is the comprehensive workflow of **PantryPilot AI**, illustrating the cycle from inventory management to DPO-based model optimization.
